...
import { Dumbbell, User, Mail, Lock, ArrowRight, AlertCircle } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0A0A0F] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Glow Backdrops */}
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-[#00E5FF]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-[#FF6B35]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold tracking-wider text-white">
            JOIN <span className="text-[#00E5FF]">MEETFIT</span>
          </h1>
          <p className="text-sm text-gray-400 mt-1">Start your AI-powered gym progression journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-mono text-gray-400 mb-2 uppercase tracking-wider">Password (min 8 characters)</label>
            <div className="relative">
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          ...
          <Link to="/login" className="text-[#00E5FF] font-semibold hover:underline">
            Sign In
          </Link>
        </div>
      </motion.div>
